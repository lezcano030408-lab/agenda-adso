 ...
 useEffect(() => {
    const cargarContactos = async () => {
      try {
        ...
        console.error("Ocurrio un error al momento de cargar los contactos:", error);
setError(
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
            ...
            <section className="space-y-4">
              {contactos.length === 0 ? (
                ...
                <p className="text-sm text-gray-500">
                  No tienes contactos añadidos en este momento, ¡Animate a añadir a uno de tus amigos!
                </p>
              ) : (
        ...
        <footer className="mt-8 text-xs text-gray-400">
          ...
          <p>Aprendices: Oscar Alvarez Lopez, Miguel Lezcano
            ,Carolina David Montoya, Angie Paola Valencia Suarez,
            Brayan Soto Rivero.</p>
        </footer>
      </div>
    </div>
  );
